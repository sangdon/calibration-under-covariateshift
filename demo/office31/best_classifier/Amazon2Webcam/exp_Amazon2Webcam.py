...
loadSrc = lambda batch_size: loadAmazon('datasets/OFFICE31', batch_size=batch_size)
loadTar = lambda batch_size: loadWebcam('datasets/OFFICE31', batch_size=batch_size)
##--------------------------------------------------
