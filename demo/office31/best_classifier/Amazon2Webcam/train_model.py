...
def train_model(run_eval=True):
    ...
    exp_name = "Amazon_model"
    from models.ResNet import ResNet50_Office31 as Model
    from data.office31 import loadAmazon, loadWebcam
    loadSrc = lambda: loadAmazon('datasets/OFFICE31', batch_size=100)
    loadTar = lambda: loadWebcam('datasets/OFFICE31', batch_size=100)
    #---------- 
