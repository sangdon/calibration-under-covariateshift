...
def train_model(run_eval=True):
    ...
    from data.office31 import loadAmazon, loadDSLR
    loadSrc = lambda: loadDSLR('datasets/OFFICE31', batch_size=100)
    loadTar = lambda: loadAmazon('datasets/OFFICE31', batch_size=100)
