...
loadTar = lambda batch_size: loadSVHN('datasets/SVHN', batch_size, image_size=28, gray=True)
## MNIST2SVHN is special. with lambda_D=1.0, it cannot learn indistinguishable feature. increase it until it does (i.e., loss_D is lose to 0.25)
#lambda_D = 0.01
