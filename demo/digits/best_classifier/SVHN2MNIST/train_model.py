...
def train_model(run_eval=True):
    ...
    exp_name = "SVHN_model"
    from models.CNN import DTN as Model
    from data.digits import loadSVHN, loadMNIST
    loadSrc = lambda: loadSVHN('datasets/SVHN', batch_size=100)
    loadTar = lambda: loadMNIST('datasets/MNIST', batch_size=100, image_size=32, gray=False)
